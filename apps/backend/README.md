...
| `atlas_inventory` | `InventoryTable`, `Product`, `Warehouse`, `Stock`, `StockTransaction` |
| `atlas_crm` | `Customer`, `Deal`, `DealItem` |
| `atlas_hr` | `Employee`, `Department`, `LeaveRequest`, `LeaveBalance`, `PayrollRecord` |
